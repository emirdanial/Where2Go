				  ...
				  <div className="container">
				    <div className="row justify-content-center">
				      <div className="col-12">
						...
						<div className="single-card-promo event">
				        ...
				        <nav className="mt-50">
				          <ul className="pagination justify-content-center">
							<li className={page < 2 ? 'page-item disabled':'page-item'}><button className="page-link" href="#" onClick={() => this.changePage(parseFloat(page)-1)}><i className="fa fa-angle-left" /></button></li>
				            {pages}
				            <li className={page === total_page ? 'page-item disabled':'page-item'}><button className="page-link" href="#" onClick={() => this.changePage(parseFloat(page)+1)}><i className="fa fa-angle-right" /></button></li>
				          </ul>
				        </nav>
				      </div>
				    </div>
