...
export default class ContestSection extends React.Component {
	constructor(props){
		super(props)
		this.state = { posts:[] }
		this.postData = { data: { app_id: '1', type_id:'3', userlat:'3.144', userlong:'144.333'} }
	}
		...
		return(
	        <div className="col-12 pb-5">
	          <div className="section-heading style-2">
	            <h4><i className="fa fa-paper-plane mr-2" aria-hidden="true" style={{color:'green'}} />Contest</h4>
	            <div className="line" />
	          </div>
	          <div>
				  <Slider {...settings}>
